...
EarlySection::EarlySection(juce::AudioProcessorValueTreeState& parameterTree)
        : earlyDamping(parameterTree, "earlyDamping", BinaryData::parameter_damping_svg, BinaryData::parameter_damping_svgSize,
          ...
          earlyRoomSize(parameterTree, "earlyRoomSize", BinaryData::parameter_room_size_svg, BinaryData::parameter_room_size_svgSize,
